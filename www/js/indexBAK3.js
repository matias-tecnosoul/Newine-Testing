...
function onDeviceReady() {
  ...
  //  document.getElementById("openBrowser").addEventListener("click", openBrowser);
    //var ref = cordova.InAppBrowser.open('https://tecnosoul.com.ar/newine/', _blank, ' location = no, toolbar=no, hideurlbar=yes');
    window.open = cordova.InAppBrowser.open;
    //cordova.InAppBrowser.open('https://tecnosoul.com.ar/newine/', '_self', 'location=no');
    ref = cordova.InAppBrowser.open('https://tecnosoul.com.ar/newine/', '_blank', 'location=no');
...
ref.addEventListener('message', function() {
  alert("We got a TEST\n");
}, true);
...
window.addEventListener('message', function(event) {
  if (event.data.external_url) {
    window.cordova.InAppBrowser.open(event.data.external_url, '_blank', 'location=no');
    alert("We got a TEST IF\n");
  }
  else {
    alert("We got a TEST ELSE\n");
  }
}, true);
//() => {
